...
namespace BelSync
{
    ...
    public static class Theme
    {
        ...
        // ── Backgrounds ────────────────────────────────────────────────
        public static Color FormBg      => IsDark ? Color.FromArgb(18,  18,  28)  : Color.FromArgb(240, 242, 248);
        ...
        public static Color InputBg     => IsDark ? Color.FromArgb(36,  37,  60)  : Color.White;
        public static Color SummaryBg   => IsDark ? Color.FromArgb(28,  29,  50)  : Color.FromArgb(248, 250, 255);
        ...
        public static Color GridOdd     => IsDark ? Color.FromArgb(33,  34,  58)  : Color.FromArgb(247, 249, 255);
        public static Color GridSelect  => IsDark ? Color.FromArgb(52,  100, 200)  : Color.FromArgb(52, 152, 219);
        public static Color BorderColor => IsDark ? Color.FromArgb(50,  52,  80)  : Color.FromArgb(218, 222, 235);
        public static Color HeaderBg    => IsDark ? Color.FromArgb(22,  23,  42)  : Color.FromArgb(44,  62,  80);
        public static Color TabBg       => IsDark ? Color.FromArgb(28,  29,  50)  : Color.FromArgb(245, 247, 252);

        // ── Text ───────────────────────────────────────────────────────
        public static Color TextPrimary   => IsDark ? Color.FromArgb(225, 226, 245) : Color.FromArgb(30,  40,  70);
        public static Color TextSecondary => IsDark ? Color.FromArgb(130, 135, 170) : Color.FromArgb(100, 110, 140);
